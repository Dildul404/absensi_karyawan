  ...
  <table class="min-w-full text-xs sm:text-sm">
    ...
    <thead class="bg-lime-50 text-lime-900">
      <tr>
        ...
        <th class="px-2 py-2 text-center font-semibold sm:px-3 sm:py-2.5 md:px-4 md:py-3 lg:px-6 lg:py-3.5 text-end">
          Aksi
        </th>
      </tr>
    </thead>
    ...
    <?php foreach ($result as $index => $item) : ?>
      ...
      <tr class="transition hover:bg-lime-50">
        ...
        <td class="hidden px-3 py-2.5 text-gray-700 sm:table-cell md:px-4 md:py-3 lg:px-6 lg:py-3.5">
           <?php echo($item["nama"]) ?>
        </td>
