...
require __DIR__ . "/../crud/read_cuti.php";
    ...
    <tbody class="divide-y divide-gray-100">
      ...
      <tr class="transition hover:bg-lime-50">
        ...
        <td class="px-2 py-2 text-gray-700 sm:px-3 sm:py-2.5 md:px-4 md:py-3 lg:px-6 lg:py-3.5">
          ...
          <span class="inline-block rounded-full bg-red-100 px-2 py-0.5 text-xs font-medium text-red-700">

            <?php echo $item["akhir_cuti"] ?>
